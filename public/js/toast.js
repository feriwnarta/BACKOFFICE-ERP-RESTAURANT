 ...
 * Toast.error, success, warning(
        $("body"), -> body html
        "Info pembayaran", -> title
        "Pembayaran untuk order ID #1234 telah diterima. Silakan proses order tersebut." -> message
    );
 * 
 * 
 * 
 * PEMAKAIAN TOAST CONFIRM
  Toast.showConfirm(
        $("body"), -> body html
        "Info pembayaran", -> title
        "Pembayaran untuk order ID #1234 telah diterima. Silakan proses order tersebut.", -> message
        function() {
            alert('yes');
        },     ->  fungsi yang dijalankan yes button
        function() {
            alert('no'); ->  fungsi yang dijalankan no button
        }
    );
 * 
 * 
